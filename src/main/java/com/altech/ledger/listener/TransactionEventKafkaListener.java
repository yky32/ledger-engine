...
public class TransactionEventKafkaListener {
    ...
    public TransactionEventKafkaListener(ObjectMapper objectMapper, TransactionIngestionUseCase ingestionUseCase) {
    ...
    public void onMessage(ConsumerRecord<String, String> record) {
        try {
            ...
            IngestionResult result = ingestionUseCase.ingest(event);
