...
import com.altech.ledger.onboarding.WalletOnboardingService;
...
public class TransactionIngestionService {
    ...
    private final WalletOnboardingService walletOnboarding;

    public TransactionIngestionService(IntegrationProperties properties, TransactionRuleEngine ruleEngine,
                                       LedgerService ledgerService, LedgerAccountRepository accounts,
                                       WalletOnboardingService walletOnboarding) {
        this.properties = properties;
        this.ruleEngine = ruleEngine;
        this.ledgerService = ledgerService;
        this.accounts = accounts;
        this.walletOnboarding = walletOnboarding;
    }
    ...
    public IngestionResult ingest(TransactionalEvent event) {
        ...
        String walletRef = walletOnboarding.walletRef(event.userId(), rule.pointCurrency());
    ...
    private IngestionResult post(TransactionalEvent event, TransactionRuleEngine.RuleDecision rule,
        ...
        LedgerService.PostingResult result = ledgerService.post(request);
        if (result.created()) {
